    ...
    <section className='contact-section' id='contact-section'>
        ...
        <section className='card-section'>
            <article className='contact-card'>
                <svg className= "svg-icons svg-others" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <article className='contact-card'>
                <a href='https://www.linkedin.com/in/anibal-juarez/' target="_blank" rel="noopener noreferrer"><svg className= "svg-icons svg-social" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a className='social-media' href='https://www.linkedin.com/in/anibal-juarez/' target="_blank" rel="noopener noreferrer"><p className='information-title'>LinkedIn</p></a>
                
            </article>
          
            <article className='contact-card'>
                 <a href='https://github.com/anibal-JUAREZ' target="_blank" rel="noopener noreferrer"><svg className = "github svg-social" width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <title>github</title>
                ...
                <a className='social-media' href='https://github.com/anibal-JUAREZ' target="_blank" rel="noopener noreferrer"><p className='information-title'>GitHub</p></a>
