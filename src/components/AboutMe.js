...
const AboutMe=() =>{
    return (
        <section className="my_information" id='my_information'>
            <article>
                    <p>&#8249;&#8250;</p>
                    <p>à propos de moi</p>
                    <p>&#8249;/&#8250;</p>
            ...
            <article>
                    <p>
                        ...
                        avec des bases de données.<br/><br/>
                        ...
                        sur les métiers du Développement Web.<br/><br/>
